...
def main():
    ...
    # 안내 문구에 종료 방법 추가
    print("라즈베리파이 가동. 2초마다 서버로 사진을 전송 (종료: 터미널에서 Ctrl + C)")
    ...
    try:
        while True:
            ...
            try:
                ...
                print(f"누적 폰: {total_phone_time}초 | 누적 졸음: {total_drowsy_time}초")
    ...
    # 터미널에서 Ctrl+C 입력 시 통계 출력 후 안전하게 종료
        ...
        print("\n==================================")
        print("모니터링 종료. 최종 성적표를 출력합니다.")
        print(f"총 측정 시간 : {total_run_time}초")
        print(f"스마트폰 만진 시간 : {total_phone_time}초")
        print(f"졸거나 딴짓한 시간 : {total_drowsy_time}초")
        print("==================================")
